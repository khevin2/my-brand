export function SettingsContainer() {
  return (
    <div className="settings-container">
      <form className="settings-profile " id="settings-profile">
      ...
      >
        ...
        <div className="settings-input-group" style="margin-top: 68px;">
          <div className="input">
          ...
          <div className="input">
            <label for="confirmpwd" className="">
              <svg
                width="28"
                height="28"
                viewBox="0 0 28 28"
